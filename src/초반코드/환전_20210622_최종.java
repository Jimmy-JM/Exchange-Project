...
public class 환전_20210622_최종 {
	...
	public static void main(String[] args) {
		...
		double exchangeRate, exchange;
		int USD, EUR, JPY, remainKRW = 0, currency, inputKRW, returnMoney;
		String selectCurrency;
		
		Scanner myInput = new Scanner(System.in);
		System.out.print("환전할 원화는: ");
		inputKRW = myInput.nextInt();
		System.out.print("환전할 톨화는:(1.USD, 2.EUR, 3.JPY)");
